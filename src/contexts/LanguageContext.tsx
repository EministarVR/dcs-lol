...
const translations: Translations = {
  de: {
    ...
    redirectNotFoundDesc: 'Dieser Discord-Server existiert nicht oder ist nicht verfügbar.',
    ...
    redirectCreateLinks: 'Erstelle stylische Kurzlinks für deinen Discord-Server.',
  ...
  en: {
    ...
    redirectNotFoundDesc: 'This Discord server does not exist or is not available.',
