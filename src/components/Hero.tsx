        ...
        <div className="text-center">
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center space-x-2 bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-full px-4 sm:px-6 py-3">
              ...
              <span className="text-gray-300 font-medium text-sm sm:text-base">{t('fastFree')}</span>
            </div>
          </div>
                  ...
                  <div className="mt-8 p-4 sm:p-6 bg-gradient-to-r from-green-900/30 to-emerald-900/30 border-2 border-green-500/30 rounded-2xl backdrop-blur-sm">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-green-300 font-bold text-base sm:text-lg">{t('yourLink')}</span>
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-3">
                      ...
                      <div className="flex space-x-3">
                        ...
                        >
                          {copied ? <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6" /> : <Copy className="w-5 h-5 sm:w-6 sm:h-6" />}
                        </button>
                        <a
                          href={shortenedUrl}
                          target="_blank"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto px-4">
            <div className="text-center p-6 sm:p-8 bg-gray-800/30 backdrop-blur-xl rounded-2xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 group">
              <div className="text-3xl sm:text-4xl font-black text-purple-400 mb-3 group-hover:scale-110 transition-transform duration-300">100+</div>
              <div className="text-gray-300 text-base sm:text-lg">{t('linksShortened')}</div>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gray-800/30 backdrop-blur-xl rounded-2xl border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 group">
              <div className="text-3xl sm:text-4xl font-black text-blue-400 mb-3 group-hover:scale-110 transition-transform duration-300">99.9%</div>
              <div className="text-gray-300 text-base sm:text-lg">{t('uptime')}</div>
            </div>
            <div className="text-center p-6 sm:p-8 bg-gray-800/30 backdrop-blur-xl rounded-2xl border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 group">
              <div className="text-3xl sm:text-4xl font-black text-cyan-400 mb-3 group-hover:scale-110 transition-transform duration-300">∞</div>
              <div className="text-gray-300 text-base sm:text-lg">{t('free')}</div>
            </div>
          </div>
        </div>
      </div>
