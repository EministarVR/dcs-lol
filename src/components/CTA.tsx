      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-16">
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-6 py-3">
              ...
              <span className="text-white font-medium">{t('ctaReady')}</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              onClick={scrollToTop}
              className="group bg-gradient-to-r from-purple-500 to-blue-600 text-white px-12 py-6 rounded-2xl font-black text-2xl hover:from-purple-600 hover:to-blue-700 transition-all duration-300 shadow-2xl hover:shadow-purple-500/50 transform hover:-translate-y-2 flex items-center space-x-3"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10 hover:border-purple-400/50 transition-all duration-300 group">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">{t('ctaFastTitle')}</h3>
            <p className="text-purple-200 text-lg">{t('ctaFastDesc')}</p>
          </div>

          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10 hover:border-blue-400/50 transition-all duration-300 group">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">{t('ctaSimpleTitle')}</h3>
            <p className="text-blue-200 text-lg">{t('ctaSimpleDesc')}</p>
          </div>

          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10 hover:border-green-400/50 transition-all duration-300 group">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">{t('ctaCommunityTitle')}</h3>
            <p className="text-green-200 text-lg">{t('ctaCommunityDesc')}</p>
          </div>
        </div>

        {/* Trust Indicators */}
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-12 text-purple-200">
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
            <span className="text-lg">{t('ctaUptimeIndicator')}</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-blue-400 rounded-full animate-pulse"></div>
            <span className="text-lg">{t('ctaLinksIndicator')}</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 bg-purple-400 rounded-full animate-pulse"></div>
            <span className="text-lg">{t('ctaCommunitiesIndicator')}</span>
          </div>
        </div>
      </div>
    </section>
